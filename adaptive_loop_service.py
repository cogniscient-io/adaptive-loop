"""
[DEPRECATED] Reference artifact for GCS Kernel adaptive loop.

This file is kept for historical context only. It was the first
implementation of the adaptive loop pattern, tightly coupled to the
GCS Kernel via MCPClient, PromptObject, and AIOrchestratorService.

It has been superseded by the `adaptive_loop` library in this repo,
which fully decouples prompt templating, response parsing, AI
transport, caching, and recording into standalone, project-agnostic
modules.

DO NOT modify this file. Use the library instead:

    from adaptive_loop import AdaptiveLoop

See library-plan.md for the migration design.
"""
